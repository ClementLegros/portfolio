                ...
                <CenterContainer>
                    ...
                    <div className="text-white">
                        <p className="text-justify mt-2 mb-5">
                            Une simple application qui permet de visualiser une image de chien aléatoirement et d'en
                            géréner
                            à l'infis
                        </p>
                        <BadgeTitleWork title={"WEBSITE"}>
                            <a className="text-cyan-500 hover:underline" href="https://dogoviewer.web.app/">
                        ...
                        <BadgeTitleWork title={"Github"}>
                            <a href="https://github.com/ClementLegros/doggo-viewer" className="text-cyan-500">
                                doggo-viewer
                            </a>
                        </BadgeTitleWork>
                    </div>
